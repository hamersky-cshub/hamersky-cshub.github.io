...
export const shared = {
  ...
  layout: {
    ...
    footer: {
      navigation: 'Navigace',
      learningContent: 'Vzdělávací obsah',
  ...
  pages: {
    home: {
      ...
      aboutInitiative: 'O této iniciativě',
    },
    ...
    about: {
      ...
      cyberSecurityHubDesc:
        'Specializovaná organizace zaměřená na kybernetickou bezpečnost, jejímž cílem je zpřístupnit znalosti o digitální bezpečnosti všem. CyberSecurity Hub řídí vzdělávací obsah a dosah projektu a zajišťuje, aby zdroje byly praktické, poutavé a relevantní pro skutečné využití ve třídě.',
      uniInlandNorway: 'Univerzita Innlandet (Norsko)',
      uniInlandNorwayDesc:
        'Se silným závazkem k inkluzivnímu a na budoucnost připravenému vzdělávání přispívá Univerzita Innlandet pedagogickými odbornými znalostmi a zkušenostmi s vývojem vzdělávacích materiálů, které jsou účinné v různorodých školních prostředích.',
      uniInnsbruck: 'Univerzita v Innsbrucku',
      uniInnsbruckDesc:
        'Jedna z předních výzkumných univerzit střední Evropy. Univerzita v Innsbrucku přináší do projektu akademickou hloubku a technické odborné znalosti a podporuje vývoj důkladného obsahu kybernetické bezpečnosti v souladu s kurikulem pro mladé žáky.',
      vilniusUni: 'Vilniuská univerzita',
      vilniusUniDesc:
        'Jako jedna z nejstarších a nejuznávanějších univerzit v baltském regionu přispívá Vilniuská univerzita výzkumnou kapacitou i širokým regionálním pohledem a pomáhá zajistit, aby zdroje projektu odrážely různorodé potřeby evropských tříd.',
    ...
    hub: {
      ...
      aria: {
        learningModulesAriaLabel: 'Vzdělávací moduly',
        moduleSummaryAriaSuffix: 'souhrn modulu',
        partListAriaSuffix: 'seznam částí',
        expandDetailsAriaPrefix: 'Rozbalit',
        collapseDetailsAriaPrefix: 'Sbalit',
        expandDetailsAriaSuffix: 'podrobnosti',
        playAriaLabel: 'Spustit hru v aplikaci Roblox',
      },
      ...
      modules: {
        dc: {
          ...
          parts: {
            ...
            p2: {
              title: 'Co znamená být digitálním občanem?',
            },
            p3: {
      ...
      challenges: {
        ...
        ap: {
          description:
            'Prozkoumejte tento profil na sociálních sítích, jako byste byli hacker hledající slabá místa. Na jaké informace byste se zaměřili?',
        },
        at: {
          description:
            'Budujte silnější heslo kolo po kole. Každá úroveň přidává novou přísadu do vašeho receptu na heslo!',
        },
        dp: {
          description:
    ...
    notFound: {
      ...
      code: '404',
      heading: 'Zabloudili jste na digitální cestě!',
      message:
        'Stránka, kterou hledáte, mohla být odstraněna, přejmenována nebo je dočasně nedostupná. Pojďme vás vrátit do bezpečných vod.',
